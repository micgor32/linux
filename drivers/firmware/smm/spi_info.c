...
static int spi_info_driver_probe(struct coreboot_device *dev)
{
    ...
    spi_info->spi_address.register_id = spi_cbtable_info->spi_address.register_id;
    spi_info->spi_address.address_space_id = spi_cbtable_info->spi_address.address_space_id;
    spi_info->spi_address.register_bit_width = spi_cbtable_info->spi_address.register_bit_width;
    spi_info->spi_address.register_bit_offset = spi_cbtable_info->spi_address.register_bit_offset;
